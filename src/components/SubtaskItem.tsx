...
const SubtaskItem = ({ taskId, subtask, dispatch }: SubtaskItemProps) => {
  ...
  return (
    <div className="subtask-item">
      ...
      <button className="delete-subtask" onClick={deleteOnClick}>
        <svg
          className="trash"
          viewBox="0 0 13 16.5"
          fill="none"
        ...
        >
          <path
            d="M 8.437 2.5 L 8.436 2.5 L 4.563 2.5 C 4.521 2.336 4.5 2.169 4.5 2 C 4.5 0.897 5.397 0 6.5 0 C 7.603 0 8.5 0.897 8.5 2 C 8.5 2.169 8.479 2.337 8.437 2.499 L 8.437 2.5 Z"
          />
          <path
            d="M 1 3.5 C 0.448 3.5 0 3.052 0 2.5 C 0 1.948 0.448 1.5 1 1.5 L 12 1.5 C 12.552 1.5 13 1.948 13 2.5 C 13 3.052 12.552 3.5 12 3.5 L 1 3.5 Z"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
